...
class AttributionConfidenceServiceTests {private final AttributionConfidenceService service=new AttributionConfidenceService();
  ...
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
 @Test void flagsSparseEvidence(){var r=service.evaluate(new AttributionConfidenceService.Request(1000,400,b("1000000"),b("300000"),b("200000"),50,20));assertEquals("LOW_CONFIDENCE",r.status());}/**
                                                                                                                                                                                                    * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                                                                                                                                    */
